...
def chat_view(request, chatroom_name='public-chat'):
    ...
    return render(request, template_name='a_rtchat/chat.html', context=context_data)


def create_chat(other_user, user):
    ...
    if my_chatroom.exists():
        for chatroom in my_chatroom:
            if other_user in chatroom.members.all():
                ...
                chatroom = create_chat(other_user, request.user)
    else:
        chatroom = create_chat(other_user, request.user)
